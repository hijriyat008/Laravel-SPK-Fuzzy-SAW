<div class="modal fade" id="add_kriteria" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="row m-2">
                            <div class="col-12">
                                ...
                                <div class="atribut my-3 ">
                                    <label for="atribut" class="form-label" style="font-weight: bold">Atribut</label>
                                ...
                                <div class="bobot mb-2">
                                    ...
                                    <div class="input-atribut d-flex">
                                        <input type="number" class="form-control @error('bobot') is-invalid @enderror"
                                            id="bobot" name="bobot" style="width:18%" required
                                            value="{{ old('bobot') }}">
