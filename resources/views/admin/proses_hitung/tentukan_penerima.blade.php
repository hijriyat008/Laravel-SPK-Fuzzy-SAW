    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tentukan Jumlah Penerima</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="card align-items-center">
                    <form action="/tentukan_penerima" method="post">
                        @csrf
                        <div class="row align-items-center m-5">
                            <div class="col-auto">
                                <label for="data" class="col-form-label">Tentukan Jumlah Penerima</label>
                            </div>
                            <div class="col-auto">
                            ...
                            <div class="col-auto mt-3">
                                <span id="" class="form-text mt-3">
                                    Tentukan Jumlah Penerima Sesuai Kebutuhan Penerimaan
                                </span>
                            </div>
                            <div class="col mt-5 ">
                                <div class="btn-save">
