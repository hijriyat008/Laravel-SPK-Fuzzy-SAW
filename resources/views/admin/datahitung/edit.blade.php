<div class="modal fade" id="edit_datahitung{{ $d->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">From Edit Data Target</h5>
                            ...
                            <div class="col-6">
                                <div class="penghasilan_orangtua mb-2">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('penghasilan_orangtua' . $d->id . '', $d->datahitung->penghasilan_orangtua) }}"
                                        required>
                                ...
                                <div class="tanggungan_orangtua mb-2">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('tanggungan_orangtua' . $d->id . '', $d->datahitung->tanggungan_orangtua) }}"
                                        required>
                                ...
                                <div class="status_rumah mb-2">
                                    ...
                                    <select id="status_rumah" name="status_rumah"
                                        ...
                                        <option></option>
                                        @if (old('status_rumah' . $d->id . '', $d->datahitung->status_rumah) == 'Menumpang')
                                            <option value="Menumpang" selected>Menumpang</option>
                                        @else
                                            <option value="Menumpang">Menumpang</option>
                                        @endif
                                        @if (old('status_rumah' . $d->id . '', $d->datahitung->status_rumah) == 'Sewa')
                                            <option value="Sewa" selected>Sewa</option>
                                        @else
                                            <option value="Sewa">Sewa</option>
                                        @endif
                                        @if (old('status_rumah' . $d->id . '', $d->datahitung->status_rumah) == 'Warisan')
                                            <option value="Warisan" selected>Warisan</option>
                                        @else
                                            <option value="Warisan">Warisan</option>
                                        @endif
                                        @if (old('status_rumah' . $d->id . '', $d->datahitung->status_rumah) == 'Milik Sendiri')
                                ...
                                <div class="kondisi_rumah mb-2">
                                    ...
                                    <select id="kondisi_rumah" name="kondisi_rumah"
                                        ...
                                        aria-label="Default select example" required>
                                        <option></option>
                                        @if (old('kondisi_rumah' . $d->id . '', $d->datahitung->kondisi_rumah) == 'Kayu')
                                            <option value="Kayu" selected>Kayu</option>
                                        @else
                                            <option value="Kayu">Kayu</option>
                                        @endif
                                        @if (old('kondisi_rumah' . $d->id . '', $d->datahitung->kondisi_rumah) == 'Semi Permanen')
                                            <option value="Semi Permanen" selected>Semi Permanen</option>
                                        @else
                                            <option value="Semi Permanen">Semi Permanen</option>
                                        @endif
                                        @if (old('kondisi_rumah' . $d->id . '', $d->datahitung->kondisi_rumah) == 'Permanen (Non Plaster)')
                                        ...
                                        @endif
                                        @if (old('kondisi_rumah' . $d->id . '', $d->datahitung->kondisi_rumah) == 'Permanen (Plaster)')
                            ...
                            <div class="col-6">
                                <div class="aset mb-2">
                                    ...
                                    <input type="text" class="form-control @error('aset') is-invalid @enderror"
                                        ...
                                        value="{{ old('aset' . $d->id . '', $d->datahitung->aset) }}" required>
                                    @error('aset')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="kendaraan mb-2">
                                    ...
                                    <input type="text" class="form-control @error('kendaraan') is-invalid @enderror"
                                        ...
                                        value="{{ old('kendaraan' . $d->id . '', $d->datahitung->kendaraan) }}"
                                        required>
                                    @error('kendaraan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="usia mb-2">
                                    ...
                                    <input type="text" class="form-control @error('usia') is-invalid @enderror"
                                        ...
                                        value="{{ old('usia' . $d->id . '', $d->datahitung->usia) }}" required>
                                    @error('usia')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="bantuan mb-2">
                                    ...
                                    <input type="text" class="form-control @error('bantuan') is-invalid @enderror"
                                        ...
                                        value="{{ old('bantuan' . $d->id . '', $d->datahitung->bantuan) }}" required>
                                    @error('bantuan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="ipk mb-2">
                                    ...
                                    <input type="text" class="form-control @error('ipk') is-invalid @enderror"
                                        ...
                                        value="{{ old('ipk' . $d->id . '', $d->datahitung->ipk) }}" required>
                                    @error('ipk')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                    ...
                    <div class="btn-action d-flex">
                        <div class="btn-back">
                            <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                data-bs-target="#show_datahitung{{ $d->nim }}" id="cek_data">Back to
                                Data</button>
                        </div>
