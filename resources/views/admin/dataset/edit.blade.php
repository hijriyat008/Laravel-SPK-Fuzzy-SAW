@foreach ($dataset as $d)
    <div class="modal fade" id="edit_dataset{{ $d->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card">
                        <form action="/admin/datasets/{{ $d->id }}" method="post">
                            @method('put')
                            @csrf
                            <div class="row m-2">
                                <div class="col-6">
                                    ...
                                    <div class="tempatlahir mb-2">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('tempat_lahir' . $d->id . '', $d->tempat_lahir) }}">
                                        @error('tempat_lahir')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="tgllahir mb-2">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('tgl_lahir' . $d->id . '', $d->tgl_lahir) }}">
                                        @error('tgl_lahir')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-6">
                                    <div class="alamat mb-2">
                                        ...
                                        <input type="text" class="form-control @error('alamat') is-invalid @enderror"
                                            ...
                                            value="{{ old('alamat' . $d->id . '', $d->alamat) }}">
                                        @error('alamat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
